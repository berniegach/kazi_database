...
/*
 * Following code will update notification period settings for the boss for their equipments
 * Arguments are:
 * id==user id.
...
if (isset($_POST['id']) && isset($_POST['notifications']))
    ...
    $sql_command="UPDATE contractors_accounts SET  notificationsequipments='$notifications', datechanged='$today' WHERE id=$id";
