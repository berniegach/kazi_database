...
/*
 * Following code will update notification period settings for the user for their equipments
 * Arguments are:
 * id==user id.
...
if (isset($_POST['id']) && isset($_POST['notifications']))
    ...
    $sql_command="UPDATE users_accounts SET  notificationsequipments='$notifications', datechanged='$today' WHERE id=$id";
