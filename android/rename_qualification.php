...
if (isset($_POST['id']) && isset($_POST['qualificationname']) && isset($_POST['newqualificationname']))
    {
        ...
        $sql_command_check="SHOW COLUMNS FROM $tablename LIKE '$newqualificationname'";
		...
		if(!$result_check || mysqli_num_rows($result_check)>0)
			...
			{
				$sql_command_add="ALTER TABLE $tablename CHANGE $qualificationname $newqualificationname TEXT";
