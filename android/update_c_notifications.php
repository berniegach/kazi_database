...
/*
 * Following code will update notification period settings for the boss for personnel requirements
 * Arguments are:
 * id==user id.
...
if (isset($_POST['id']) && isset($_POST['notifications']))
    ...
    $sql_command="UPDATE contractors_accounts SET  notifications='$notifications', datechanged='$today' WHERE id=$id";
